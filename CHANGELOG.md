...
- fix(download): bump yt-dlp to 2026.8.19 (media download 403) (#304)
...
- fix(lyrics): fallback gate vs aligner-kept lines — VAD-trimmed outputs ship as forced_aligned (#253) (#254)
...
- fix(lyrics): repair aligner boundary absorption + aligned-LRC fallback on coverage reject (#241) (#242)
...
- fix(lyrics): LRCLIB editions expansion for title-matched wrong-duration candidates (#233) (#234)

## [v0.32.0] - 2026-07-11

_Bump: minor_

- feat(worker): word timing for lrclib_synced — align curated text, merge word tags (#222) (#229)
- feat(lyrics): LRCLIB title-cleanup ladder + artist-free duration-gated retry (#230) (#231)
